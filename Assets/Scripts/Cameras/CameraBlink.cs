...
namespace GLEAMoscopeVR.Cameras
{
    public class CameraBlink : MonoBehaviour
    {
        ...
        [Header("Eye Closed")] [Tooltip("How many seconds the 'eye' remains shut for once fading to black.")]
        public float EyeRemainClosedTime = 0.5f;

        [Header("Unity Events")] [Tooltip("Invoked when the eye begins to close.")]
