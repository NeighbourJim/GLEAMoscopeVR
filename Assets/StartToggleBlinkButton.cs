...
public class StartToggleBlinkButton : MonoBehaviour, IActivatable, IHideableUI
{
    ...
    {
        _settingsManager.SetBlinkInPassiveMode(!_settingsManager.UserSettings.BlinkInPassiveMode);
        SetCheckedState();
    }
    ...
    {
        checkedImage.enabled = _settingsManager.UserSettings.BlinkInPassiveMode;
    }
